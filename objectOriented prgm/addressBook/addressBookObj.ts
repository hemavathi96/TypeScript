/******************************************************************************
 *  Execution       :1. default node          : cmd> node addressBook.ts
 *  @purpose        :To create a proper address book to store new address information.
    @description    :An address book holds a collection of entries,each recording a person's first
 *                     phone number.
 *  @file           : addressBook.ts
 *  @overview       : Add new entries each time and manage that address book and perform operations
