...
var companySharesStack = /** @class */ (function () {
    function companySharesStack() {
        this.stock = new utilDataStructure_1.StackLinkedList;
        try {
            var data = JSON.parse(file.readFileSync("/home/bridgeit/typeScript/objectOriented prgm/stockAccountStack/customer.json"));
     ...
     */
    companySharesStack.prototype.addToStack = function () {
        try {
            var flag = false;
            do {
     ...
     * using stack implemented using linkedlist and push it to stack.
     */
    companySharesStack.prototype.removeFromStack = function () {
        try {
            console.log(this.stock.printShares());
     ...
     */
    companySharesStack.prototype.print = function () {
        try {
            console.log(this.stock.printShares());
        }
        catch (err) {
     ...
     */
    companySharesStack.prototype.writeStock = function () {
        try {
            file.writeFileSync("/home/bridgeit/typeScript/objectOriented prgm/stockAccountStack/customer.json", JSON.stringify(this.stock.printShares()), function (err) {
                if (err) {
                    throw err;
                }
            });
    ...
    return companySharesStack;
}());
exports.companySharesStack = companySharesStack;
